...
exports.handler = async (event) => {
  try {
    ...
    const disneySubjects = [
      "amazon.com: Sign-in attempt1",
      "amazon.com: Intento de inicio de sesión1",
      "Amazon password assistance1",
      "Your one-time passcode for Disney+1",
      "Tu código de acceso único para Disney+1" // Asunto específico de Disney+
    ];
